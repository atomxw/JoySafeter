  ...
  translation: {
    ...
    chat: {
      ...
      examples: {
        ...
        ctf1: 'Analyze CTF challenges, identify vulnerability types and attack vectors',
        ctf2: 'Write an exploit script to obtain shell by exploiting buffer overflow vulnerabilities',
        ctf3: 'Crack encryption algorithms and recover original plaintext data',
        ctf4: 'Analyze network traffic packets and extract hidden flag information',
        enterpriseScan1: 'Perform port scanning and service identification on target systems',
        enterpriseScan2: 'Simulate SQL injection and XSS attacks to test web application security',
        enterpriseScan3: 'Exploit vulnerabilities to verify the effectiveness of security measures',
        enterpriseScan4: 'Simulate attack chains to assess overall security defense capabilities',
        whiteboxScanner1: 'Static code analysis to detect potential security vulnerabilities',
        whiteboxScanner2: 'Analyze source code dependencies and identify outdated libraries and components',
        whiteboxScanner3: 'Detect hardcoded keys and sensitive information in code',
        whiteboxScanner4: 'Scan code repositories and generate security vulnerability lists',
