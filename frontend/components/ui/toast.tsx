...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ...
    className={cn(
      ...
      'fixed top-0 left-1/2 -translate-x-1/2 z-[10000200] flex max-h-screen w-full flex-col gap-2 p-4 sm:max-w-[420px]',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={cn('text-xs text-[var(--text-muted)] group-[.destructive]:text-red-700 dark:group-[.destructive]:text-red-300', className)}
    {...props}
  />
))
